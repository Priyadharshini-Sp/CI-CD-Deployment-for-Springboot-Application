...
<body>
<h1 style="background-color:#98DBC6;"><center>List Of Users</center></h1>
<%List<Users> u=(List<Users>)request.getAttribute("list");
%>

<table  border="1" align="center">
<tr bgcolor="#F18D9E"><th>UserId</th><th>UserName</th><th>Email</th><th>Address</th><th>PhoneNo</th><th>Actions</th></tr>
<%for(Users us:u){ %>
