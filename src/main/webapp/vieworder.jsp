...
<body>
<h2 style="background-color:#98DBC6;"><center>List Of Orders</center></h2>
<%List<Orders> o=(List<Orders>)request.getAttribute("list");
%>

<table  border="1" align="center">
<tr bgcolor="#F18D9E"><th>OrderId</th><th>ShoeId</th><th>ShoeBrand</th><th>Color</th><th>Cost</th></tr>
<%for(Orders os:o){ %>
