...
<body>
<h1 style="background-color:#98DBC6;"><center>List Of Shoes</center></h1>
<%List<Shoe> s=(List<Shoe>)request.getAttribute("list");
%>

<table  border="1" align="center">
<tr bgcolor="#F18D9E"><th>Shoeid</th><th>ShoeBrand</th><th>Color</th><th>Quantity</th><th>Cost</th><th>Actions</th></tr>
<%for(Shoe ss:s){ %>
